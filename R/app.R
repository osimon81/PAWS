      ...
      tabItems(
        ...
        tabItem(tabName = "preprocess",
                ...
                fluidRow(
                  ...
                  box(title = "Select body parts, axes to track trajectories.",
        ...
        tabItem(tabName = "paws_diagnostics",
                h2("Run PAWS diagnostics using sample CSV files before analyzing full dataset:"),
                box(title = "Upload a CSV and enter video parameters.",
                    ...
                    numericInput("diagnostic_ref_distance", "Enter the measured distance (mm) between your reference points here:",
                                 value = 40),
                    numericInput('diagnostic_scale_factor', "Enter a backup mm/px scale factor to scale all your videos (leave blank if you intend to use reference points!)", value = NA),
                ),
                box(title = "Enter parameters for PAWS analysis:",
